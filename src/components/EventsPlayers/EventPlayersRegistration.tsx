...
export const EventRegistrationPage = () => {
    ...
    const { data: event, isLoading: isEventLoading } = useGetOne('events', { id: eventId });
    ...
    return (
        <Card sx={{ 
            ...
            <CardContent sx={{ p: isMobile ? 2 : 3 }}>
                <Typography variant={isMobile ? 'h5' : 'h4'} gutterBottom align="center" sx={{ mb: 2 }}>
                ...
                {!isEventLoading && event && (
                    <Box sx={{ 
                        ...
                        <Typography variant={isMobile ? 'subtitle1' : 'h4'} sx={{ fontWeight: 'bold' }}>
                            {event.name}
                        </Typography>
                        <Box sx={{ mt: 1 }}>
